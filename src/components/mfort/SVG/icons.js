...
export const AI = () => (
  <svg width="79" height="79" viewBox="0 0 79 79" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M14.1818 63.569C20.9599 63.569 26.4545 58.0762 26.4545 51.3005C26.4545 44.5249 20.9599 39.0321 14.1818 39.0321C7.40378 39.0321 1.90909 44.5249 1.90909 51.3005C1.90909 58.0762 7.40378 63.569 14.1818 63.569Z" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10"/>
    <path d="M59.5909 77.0643C65.0133 77.0643 69.4091 72.6701 69.4091 67.2496C69.4091 61.829 65.0133 57.4348 59.5909 57.4348C54.1685 57.4348 49.7727 61.829 49.7727 67.2496C49.7727 72.6701 54.1685 77.0643 59.5909 77.0643Z" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10"/>
...
export const SmartExchange = () => (
  <svg width="79" height="79" viewBox="0 0 79 79" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M40.7248 77.826C50.1478 77.826 59.5683 74.2326 66.7552 67.0458C79.8846 53.9222 81.0272 33.3554 70.1806 18.9413L62.8169 11.5802" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10"/>
    <rect width="73.6364" height="56.4348" fill="black" fillOpacity="0" transform="translate(2.67934 11.5765)"/>
...
export const Tokenized = () => (
  <svg width="66" height="79" viewBox="0 0 66 79" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M64.9545 49.2231C64.9545 53.966 50.6679 57.811 33.0455 57.811C15.423 57.811 1.13636 53.966 1.13636 49.2231" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10" strokeLinejoin="bevel"/>
    <path d="M64.9545 29.5936C64.9545 34.3365 50.6679 38.1815 33.0455 38.1815C15.423 38.1815 1.13636 34.3365 1.13636 29.5936" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10" strokeLinejoin="bevel"/>
    <path d="M33.0455 18.552C50.6684 18.552 64.9545 14.7071 64.9545 9.96409C64.9545 5.22112 50.6684 1.37619 33.0455 1.37619C15.4226 1.37619 1.13636 5.22112 1.13636 9.96409C1.13636 14.7071 15.4226 18.552 33.0455 18.552Z" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10" strokeLinejoin="bevel"/>
...
export const Wallet = () => (
  <svg width="79" height="59" viewBox="0 0 79 59" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8.04546 1.56522H66.9545V8.92627" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10"/>
    <path d="M8.04546 1.56522C4.65573 1.56522 1.90909 4.31212 1.90909 7.69943" stroke="#05A8F3" strokeWidth="3" strokeMiterlimit="10"/>
